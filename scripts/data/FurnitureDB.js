...
export const FURNITURE_DB = [
    ...
    { id: 'cozy_computer_chair', type: 'floor', layer: 1, name: '舒适电脑椅', price: 120, color: 0x3498db, size: { x: 0.5, y: 0.8, z: 0.5 }, modelFile: 'cozycomputerchair.glb', modelScale: 1.5, canSleep: true, fixBottom: true },
    { id: 'wooden_chair', type: 'floor', layer: 1, name: '木椅子', price: 60, color: 0x8d6e63, size: { x: 0.5, y: 0.8, z: 0.5 }, modelFile: 'woodenchair.glb', modelScale: 1.2, canSleep: true, fixBottom: true },
    ...
    { id: 'wooden_dining_table', type: 'floor', layer: 1, isSurface: true, name: '木餐桌', price: 100, color: 0x8d6e63, size: { x: 1.5, y: 0.8, z: 1.5 }, modelFile: 'woodendiningtable.glb', modelScale: 1.8, fixBottom: true },
